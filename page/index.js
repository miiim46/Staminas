...
(() => {
  ...
  let MINX = 0;
  let MINY = 0;
  let record = hmFS.SysProGetInt("Record");
  let start = 0;
  let rec = 0;
  let click = 0;
...
__$$module$$__.module = DeviceRuntimeCore.Page({
  onInit() {
    ...
    const button1 =hmUI.createWidget(hmUI.widget.BUTTON, {
      x :(192-120)/2,
      y: 140,
      w: 120,
      h: 120,
...
() => {
  ...
  button1.setProperty(hmUI.prop.MORE, {
    y: 600
  });
                                  ...
                                  y: 140
                                    ...
                                    setTimeout(
                                      () => {
                                       ...
                                       console.log(record);
                                        hmFS.SysProSetInt("Record", record);
                                        
                                        Batt.setProperty(hmUI.prop.MORE, {
                                          text: time
                                          });
...
const text5 = hmUI.createWidget(hmUI.widget.TEXT, {
  x: 40,
  y: 400,
  w: 120,
  h: 50,
  ...
  onDestroy() {
    hmFS.SysProSetInt("Record", record);
    hmUI.widget.IMG,{x:50,y:50,src:"icon.png"}
